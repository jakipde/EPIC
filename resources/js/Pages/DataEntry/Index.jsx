...
export default function Index(props) {
    ...
    return (
        <AuthenticatedLayout page={'System'} action={'DataEntry'}>
            <Head title=" DataEntry" />

            <div>
                <Card>
                    <div className="flex justify-between mb-4">
                        <HasPermission p="create-dataEntry">
                            <Button
                                size="sm"
                                ...
                                {data.map((dataEntry, index) => (
                                    <tr key={dataEntry.id}>
                                        ...
                                        <td className="text-end">
                                            <Dropdown>
                                                <HasPermission p="update-dataEntry">
                                                    <Dropdown.Item
                                                        onClick={() =>
                                                            toggleFormModal(
                                                                dataEntry
                                                ...
                                                <HasPermission p="delete-dataEntry">
                                                    <Dropdown.Item
                                                        onClick={() =>
                                                            handleDeleteClick(
                                                                dataEntry
